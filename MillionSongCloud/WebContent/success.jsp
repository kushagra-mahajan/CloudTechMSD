...
<s:form id="successForm" name="successForm" enctype="multipart/form-data">
	<body>
		<div id="header">
			<div id="logo">
				<h1>Million Song</h1>
			...
			<div id="menubar">
				<ul id="menu">
					<li><a id="home" title="Go to Home Page"
						href="#" onclick="loadWebPages(this.id);return false;">Home</a></li>
